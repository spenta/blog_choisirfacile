...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number('Aucun commentaire', 'Un commentaire', '% commentaires' );?> sur &#8220;<?php the_title(); ?>&#8221;</h3>
...
<h3><?php comment_form_title( 'Laisser un commentaire', 'Laisser un commentaire à %s' ); ?></h3>
...
<label for="email"><small>Adresse e-mail (ne sera pas publiée) <?php if ($req) echo "(obligatoire)"; ?></small></label></p>
